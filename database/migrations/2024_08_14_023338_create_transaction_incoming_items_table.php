...
return new class extends Migration
{
    ...
    {
        Schema::create('transaction_incoming_items', function (Blueprint $table) {
            $table->id();
            $table->string('code');
        ...
        Schema::table('transaction_incoming_items', function (Blueprint $table) {
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('transaction_incoming_items');
    }
};
